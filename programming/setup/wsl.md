...
2. If you get the error `Invalid command line option: --set-default-version` when attempting to set default WSL version (step 7 above), then your version of Windows may need updating. Run Windows Update and go back to step 5 above.
